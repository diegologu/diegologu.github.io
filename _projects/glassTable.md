...
img: assets/img/glass_table/gnrl_assembly.png
importance: 1
category: coursework
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/glass_table/gnrl_assembly.png" title="example image" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/glass_table/blueprint1.png" title="example image" class="img-fluid rounded z-depth-1"  %}
    </div>
</div>
